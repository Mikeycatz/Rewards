...
const UserEditScreen = () => {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    try {
      await updateUser({ userId, name, email, isAdmin, points });
  ...
  return (
    <div className="p-4 lg:h-[60vh]">
      ...
      {isLoading ? (
        ...
        <div>
          <h1 className="text-2xl text-primary py-3">Edit User</h1>
